...
public class MonitorThread implements Runnable {
	...
	public static void readBigFile_hotel(String inputFile) {
		...
		LogUtils.logWarn("readBigFile_hotel，总共耗时：" + (end - start) + "ms" + ",文件hotel_revenue_hotel_info_dwd，BigVar.hid2star个数"+ BigVar.hid2star.size());
	}
	...
	public static void readBigFile_cvt(String inputFile) {
		...
		long end = System.currentTimeMillis();// 结束时间
		LogUtils.logWarn("readBigFile_cvt，总共耗时：" + (end - start) + "ms" + ",文件user_hist_cvthotel_info，BigVar.user2cvthid个数"+ BigVar.user2cvthid.size());
	}
	...
	public static void readBigFile_weight(String inputFile) {
		...
		long end = System.currentTimeMillis();// 结束时间
		LogUtils.logWarn("readBigFile_weight，总共耗时：" + (end - start) + "ms"+ ",文件cvr_feat_weight，BigVar.feat2w个数"+ BigVar.feat2w.size());
	}
